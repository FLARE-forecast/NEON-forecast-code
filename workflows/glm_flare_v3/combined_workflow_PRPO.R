...
config_obs <- yaml::read_yaml(file.path(lake_directory,'configuration',config_set_name,'observation_processing_PRPO.yml'))
...
while(noaa_ready){
  ...
  scoring <- generate_forecast_score_arrow(targets_df = targets_df,
                                           ...
                                           local_directory = './NEON-forecast_code/scores/PRPO',
...
RCurl::url.exists("https://hc-ping.com/4227ddc1-391f-4d9d-9cf7-8a0bfc27d62f", timeout = 5)
