...
config_obs <- yaml::read_yaml(file.path(lake_directory,'configuration',config_set_name,'observation_processing_TOOK.yml'))
...
while(noaa_ready){
  ...
  scoring <- generate_forecast_score_arrow(targets_df = targets_df,
                                           ...
                                           local_directory = './NEON-forecast_code/scores/TOOK',
...
RCurl::url.exists('https://hc-ping.com/97a2f542-bfd0-42d1-9200-c2741699de1b', timeout = 5)
