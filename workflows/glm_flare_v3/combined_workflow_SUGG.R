...
config_obs <- yaml::read_yaml(file.path(lake_directory,'configuration',config_set_name,'observation_processing_SUGG.yml'))
...
while(noaa_ready){
  ...
  scoring <- generate_forecast_score_arrow(targets_df = targets_df,
                                           ...
                                           local_directory = './NEON-forecast_code/scores/SUGG',
  ...
  RCurl::url.exists('https://hc-ping.com/23d52a25-e3ca-4e7f-829f-49afa229f141', timeout = 5)
